...
drop table CONCEPTOTIPOPERSONA;
...
drop index HISTORICOVALORCONCEPTO_PK;

drop table HISTORICOVALORCONCEPTO;
...
drop index TENENCIA_PK;

drop table TENENCIA;

drop index TIPOESTRUCTURA_PK;
...
drop index TIPOTRANSACCION_PK;

drop table TIPOTRANSACCION;

drop index UNIDADMEDIDA_PK;
